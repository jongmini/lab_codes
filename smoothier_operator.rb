...
class Blender
  ...
  def initialize(list, power=false)
    @list = list
    @power = power
  end
  ...
  def turn_on()
    puts "would you like to blend? (on/off)"
    answer = gets.chomp.downcase
      if answer == "on"
        puts "enjoy your smoothie by your personal smoothie operator! \n"
        @power = true
        self.prep
        self.blend
      else
        @power = false
        puts "turn on the switch to blend"
      end
  end
